...
%    \vspace{1cm}
%    {\scshape\Large Facultad de ciencias exactas y tecnología \par}
%    \vspace{3cm}
%    {\scshape\Huge Informe de Laboratorio IV \par}
%    \vspace{3cm}
%    {\itshape\Large Formación de imágenes por refracción con lentes \par}
%    \vfill
%    {\Large Autores: \par}
...
\section*{Marco teórico}
    ...
    \begin{Figure}
        \centering
        \includegraphics[width=0.7\linewidth]{RayosLD.jpg}
