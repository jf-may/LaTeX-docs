...
\section*{Materiales, métodos y recolección de datos}
    ...
    \subsection*{Métodos}
        ...
        \begin{Figure}
            \centering
            \includegraphics[width=0.5\linewidth]{mediciones_movimientoLineal.png}
        ...
        \begin{Figure}
            ...
            \captionof{figure}{Gráfica de aceleración en función del tiempo del pistón para un valor de 7 V}
        \end{Figure}
...
\begin{thebibliography}{99}
    ...
    \bibitem{Motor} D. E. Ponzetti, \emph{Proyecto experimental: Motor solenoide.} (Tucumán, 2018)

    \bibitem{Sears} H. D. Young, R. A. Freedman, \emph{Sears and Zemansky's University Physics: with Modern Physics}, 14th ed. (Pearson, San Francisco, 2015).

    \bibitem{Jackson} J. D. Jackson, \emph{Classical Electrodynamics}, 3rd ed. (Wiley, New York, 1999).
